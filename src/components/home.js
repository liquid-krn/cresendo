    ...
    style={{
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div class="text-center welcome shadow-2xl">
            <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
              Welcome to <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-pink-400"> Cresendo</span>
            </h1>
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
             Your gateway to reliable <span className='text-3xl bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-pink-400'>Bitcoin (BTC)</span> and <span class='text-3xl bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-pink-400'>Ethereum (ETH)</span> trades. Join us today to experience seamless cryptocurrency transactions!!
            </p>
